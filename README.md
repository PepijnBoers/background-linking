...
The results file should be stored in `bglinking/resources/candidates`
...
- term-embedding: Scaler for embedding weight of edges, i.e. cosine similarity between term vectors (default = 0.0)
